...
# from university_stub.config import settings
...
from unigate.models.base import DBUniBase  # noqa: E402

target_metadata = DBUniBase.metadata
...
def get_url() -> str:
    return str(settings.UNISTUB_DB_URI)
